...
public class Common {
    ...
    //Move the poker card (with animation effect)
...
//                Retrieve suit
                // 1 - Spades, 2 - Hearts, 3 - Clubs, 4 - Diamonds, 5 - Jokers
                int a1 = Integer.parseInt(o1.getName().substring(0, 1));
                int a2 = Integer.parseInt(o2.getName().substring(0, 1));

                //Retrieve the number on the card, which also represents the card's value
                //1-A ... 11-J 12-Q 13-K
                int b1 = Integer.parseInt(o1.getName().substring(2));
                int b2 = Integer.parseInt(o2.getName().substring(2));

                //Calculate the card's value for sorting
                //the number in cards are between 3-10，and the value is 3~10
                //3:value 3
                //...
                //10:value 10
                //J:value 11
                ...
                //A：1 + 20 = 21
                //2：2 + 30 = 32
                //black joker：1 + 100 = 101
                //red joker：2 + 100 = 102

                //calculate the value of jokers
                if (a1 == 5) {
                    b1 += 100;
                }
                if (a2 == 5) {
                ...
                //if the value is the same then order the sort by the color
                if (flag == 0) {
                    return a2 - a1;
                } else {
                    return flag;
